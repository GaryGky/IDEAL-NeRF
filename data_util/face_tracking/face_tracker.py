...
parser.add_argument('--idname', type=str, default='Noah',
                    help='idname of target person')
parser.add_argument('--img_h', type=int, default=0, help='image height')
parser.add_argument('--img_w', type=int, default=0, help='image width')
...
torch.save({'id': id_para.detach().cpu(), 'exp': exp_para.detach().cpu(),
            ...
            'focal': focal_length.detach().cpu()}, os.path.join(id_dir, 'track_params_new.pt'))
print('params saved')
